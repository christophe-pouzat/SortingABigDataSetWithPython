...
f = h5py.File('locust20010201.hdf5','r')
print(f.attrs['LabBook'])
#+END_SRC
...
#+BEGIN_SRC python :session *Python* :results output :exports code
print(f['Continuous_1'].attrs['log_file_content'])
#+END_SRC
...
data = [f['Continuous_1']['trial_01'][name][...] for name in ch_names]
#+END_SRC
...
#+NAME: download-and-load-sorting_with_python
#+BEGIN_SRC python :session *Python* :results silent
